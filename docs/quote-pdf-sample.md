...
**Design guide & style variants:** See **`docs/quote-pdf-design-guide.md`** for quoting best practices and three PDF styles (Clean minimal, Professional zebra, Classic bordered). HTML previews: `quote-pdf-sample-style-a.html`, `quote-pdf-sample-style-b.html`, `quote-pdf-sample-style-c.html`. Multipage sample PDFs: `npx tsx scripts/generate-sample-pricing-proposal-pdf.ts` → `docs/sample-pricing-proposal-style-{a,b,c}.pdf`.
