    ...
    <div className="container-custom py-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Manage cross-references and non-WAGO product catalogs. Admin only.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Maps competitor manufacturer + part number to WAGO parts. Upload CSV files with flexible column mapping.
          </p>
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              Supports custom column headers with mapping wizard. Download sample template from the import page.
            </p>
          </div>
        </div>
