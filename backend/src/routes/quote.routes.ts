...
router.post('/', authenticate, authorize('ADMIN', 'DISTRIBUTOR'), quoteController.createQuote);
...
router.patch('/:id', authenticate, authorize('ADMIN', 'DISTRIBUTOR'), quoteController.updateQuote);
router.delete('/:id', authenticate, authorize('ADMIN', 'DISTRIBUTOR'), quoteController.deleteQuote);
